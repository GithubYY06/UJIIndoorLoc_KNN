...
*	analysis. 
<br/>
Programme user interface description (in Latvian) see in [description folder](https://github.com/arthuraleksandrovich/UJIIndoorLoc_KNN/blob/master/description/Description_Lat.md). 
